																					...
																					<div class="col-sm-6">
																						<spring:bind path="nama">
																							<form:input type="text" class="form-control"
																								id="nama" path="nama" value="${pemohon.nama}" disabled="true"></form:input>
																						</spring:bind>
																					</div>
																				</div>
																				<div class="form-group">
																					...
																					<div class="col-sm-6">
																						<spring:bind path="tarikhMohon">
																							<form:input type="text" class="form-control"
																								...
																								value="${pemohon.tarikhMohon}" disabled="true"></form:input>
																						</spring:bind>
																					</div>
																				</div>
																					...
																					<div class="col-sm-6">
																						<spring:bind path="bahagian">
																							<form:input type="text" class="form-control"
																								...
																								value="${pemohon.bahagian}" disabled="true"></form:input>
																						</spring:bind>
																					</div>
																				</div>
																				<div class="form-group">
																					...
																					<div class="col-sm-6">
																						<spring:bind path="tempatBertugas">
																							<form:input type="text" class="form-control"
																								...
																								value="${pemohon.tempatBertugas}" disabled="true"></form:input>
																						</spring:bind>
																					</div>
																				</div>
